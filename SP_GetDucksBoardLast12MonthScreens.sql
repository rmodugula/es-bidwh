...
/****** Object:  View [dbo].[GetDucksBoardLast12MonthScreens]    Script Date: 12/11/2014 2:01:45 PM ******/
SET ANSI_NULLS ON
GO
...
and DATEDIFF(mm,EndDate,GETDATE())>=2 and m.ProductSku in ('20005','20999','20997','20000','20200','20995','20993','20992','80000','80001','80002','80003') 
group by t.EndDate 
...
and m.ProductSku in ('20005','20999','20997','20000','20200','20995','20993','20992','80000','80001','80002','80003') group by t.EndDate)Adj on Screen.LastDayOfMonth=adj.LastDayOfMonth 
--order by 1
)Q
...
left join [bidw].dbo.[TimeInterval] T 
on m.Year=t.Year and m.Month=t.Month where DATEDIFF(mm,EndDate,GETDATE())<=12 and DATEDIFF(mm,EndDate,GETDATE())>=1 
and m.ProductSku in ('20005','20999','20997','20000','20200','20995','20993','20992','80000','80001','80002','80003') 
group by t.EndDate 

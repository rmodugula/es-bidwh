...
/****** Object:  View [dbo].[VW_FillsMasterView]    Script Date: 04/08/2014 15:07:00 ******/
SET ANSI_NULLS ON
GO
...
,ProductType,F.ProductName,FillType,FillStatus,Fills as Fills,FixAdapterName,OpenClose
...
left join (select Year, Month,Username,FullName,Accountid,CountryCode,CustomField1,CustomField2,CustomField3 from dbo.[user] 
--where YEAR=YEAR(getdate()) and MONTH=Month(getdate())
) U 
on F.UserName=U.UserName and F.AccountId=U.AccountId and f.Year=u.Year and f.Month=u.Month
